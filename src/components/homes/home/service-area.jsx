...
const cta_data = [
    {
        ...
        title: "Solutions",
        description: <>Elevating Efficiency in  <br />  Digital, IT, Safety, and Audio-Video</>,
        link: "/service"
    },
    {
        id: 2, 
        ...
        description: <>Smart Solutions for Charging,  <br /> Multimedia, and Travel Comfort</>,
                                ...
                                <div className="tp-cta p-relative text-center tp-cta-space" 
                                    ...
                                    <div className="tp-cta-text-wapper">
                                        ...
                                        <div className="cta-link pt-110">
                                            <Link href={item.link}><i className="fal fa-long-arrow-right"></i></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
