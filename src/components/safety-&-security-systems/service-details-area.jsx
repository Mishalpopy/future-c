...
over_veiw_list: [
    ...
    info: "Ensure early detection and response to fires with our Fire Alarm and Detection Systems. Safeguard your property effortlessly."},
     ...
     title: "Burglar Alarm",
    info:"A burglar alarm detects unauthorized access, safeguarding against theft and property damage in residential and commercial spaces. Our modern intruder alarm systems, from small setups to advanced projects, utilize cutting-edge technology and offer excellent support."},
    {id: 7,
        img: "/assets/img/services/service-details-bg.jpg",
