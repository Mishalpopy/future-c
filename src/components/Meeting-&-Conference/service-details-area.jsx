...
const service_details_content = {
    img: "/assets/img/hospitality/mee/bg.jpeg",
    title: "Service Overview",
    info_1: <>Empower hotels to effortlessly showcase their meeting and conferencing spaces with our cutting-edge connectivity solutions for seamless promotion.</>,

over_veiw_list: [
    {id: 1,
        img: "/assets/img/hospitality/mee/001.jpg",
         icon: <SiFirewalla />,
     title: "Meeting Owl Pro",
     info: "360° smart conferencing camera with a microphone and speaker all in one device with the highest resolution and best quality sound."},
